...
1.Create two subclasses:
    ...
    a) SavingsAccount: allows withdrawal but limits it to ₹10,000 per transaction.

    b) CheckingAccount: allows withdrawal with a ₹10 fee per transaction.
